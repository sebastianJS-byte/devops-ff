# FastAPI Tech Store API

This is a sample project demonstrating a simple Tech Store API built with Python and FastAPI. It provides basic CRUD (Create, Read, Update, Delete) operations for managing products. The data is stored in a simple `db.json` file.
...
- To run tests, open the Test Panel in VS Code or run `pytest` in the terminal.
